  ...
  return `
    ...
    >
      ...
      <div class="w-2/3 p-4 flex flex-col gap-2">
        <h3 class="font-bold text-blue-950 text-lg">Malecon del Rio</h3>

        <div class="flex items-center gap-1 text-amber-500">
          <img src="/src/assets/icons/star.svg" alt="estrella" class="w-4 h-4" />
          <img src="/src/assets/icons/star.svg" alt="estrella" class="w-4 h-4" />
          <img src="/src/assets/icons/star.svg" alt="estrella" class="w-4 h-4" />
          <img src="/src/assets/icons/star.svg" alt="estrella" class="w-4 h-4" />
          <img src="/src/assets/icons/star.svg" alt="estrella" class="w-4 h-4" />
        ...
        <p class="text-sm text-gray-700 leading-relaxed">
          Un lugar espectacular para caminar, disfrutar del rio y ver los atardeceres. Imprescindible!
        </p>
