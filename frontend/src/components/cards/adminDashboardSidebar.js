...
import { renderAdminDashboardAllOrganizerRequests } from "./adminDashboardAllOrganizerRequests.js";
import {
    ...
    <aside class="flex min-h-screen flex-col bg-[#06264a] px-5 py-6 text-white lg:h-screen">
      ...
      <nav aria-label="Navegacion del panel de administracion" class="flex flex-1 flex-col">
        ...
        <ul class="space-y-2 text-sm font-semibold">
          <li>
            <a href="#"  aria-current="page" class="flex cursor-pointer items-center gap-3 rounded-lg bg-blue-600 px-4 py-2.5 text-white shadow-lg shadow-blue-950/20 transition hover:bg-blue-500">
          ...
          <li>
            <a href="#" data-admin-sidebar-users="true" class="flex cursor-pointer items-center gap-3 rounded-lg px-4 py-2.5 text-slate-200 transition hover:bg-white/10 hover:text-white">
              <svg aria-hidden="true" class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <li>
            <a href="#" data-admin-sidebar-events="true" class="flex cursor-pointer items-center gap-3 rounded-lg px-4 py-2.5 text-slate-200 transition hover:bg-white/10 hover:text-white">
              <svg aria-hidden="true" class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M8 2v4" />
                <path d="M16 2v4" />
          ...
          <li>
            <a href="#" data-admin-sidebar-places="true" class="flex cursor-pointer items-center gap-3 rounded-lg px-4 py-2.5 text-slate-200 transition hover:bg-white/10 hover:text-white">
              <svg aria-hidden="true" class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <li>
            <a href="#" data-admin-sidebar-reviews="true" class="flex cursor-pointer items-center gap-3 rounded-lg px-4 py-2.5 text-slate-200 transition hover:bg-white/10 hover:text-white">
              <svg aria-hidden="true" class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <li>
            <a href="#" data-admin-sidebar-requests="true" class="flex cursor-pointer items-center gap-3 rounded-lg px-4 py-2.5 text-slate-200 transition hover:bg-white/10 hover:text-white">
              <svg aria-hidden="true" class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
