export function renderEventCalendar() {
  return `
    ...
    <ul class="grid grid-cols-7 mb-4 text-center text-xs font-semibold uppercase text-slate-400">
      <li>Lun</li><li>Mar</li><li>Mie</li><li>Jue</li><li>Vie</li><li>Sab</li><li>Dom</li>
    </ul>
    ...
    <section class="mt-8">
      <hgroup class="mb-4 flex items-center justify-between">
        <h3 class="text-lg font-bold text-slate-900">Proximos eventos</h3>
        ...
        <li>
          <article class="flex items-center gap-4 rounded-2xl border border-slate-200 p-4 hover:border-blue-500 transition">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-slate-500">Malecon del Rio</p>
            </div>
          </article>
        </li>
