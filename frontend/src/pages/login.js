...
export function login() {
  ...
  <!-- CONTENIDO PRINCIPAL -->
  <main class="hero-bg min-h-[calc(100vh-76px)] bg-[url('/images/login-hero.png')] bg-cover bg-center bg-no-repeat">

    <section class="relative grid grid-cols-1 lg:grid-cols-[58%_42%] min-h-[calc(100vh-76px)] overflow-hidden">
