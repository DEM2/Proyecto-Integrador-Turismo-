      ...
      <section class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <figure class="relative h-64 overflow-hidden">
            <img
              src="/src/assets/img/carnaval-evento.jpg"
        ...
        >
          ...
          <figure class="relative h-64 overflow-hidden">
            <img
              src="/src/assets/img/concierto-rio.jpg"
        ...
        >
          ...
          <figure class="relative h-64 overflow-hidden">
            <img
              src="/src/assets/img/noche-jazz.jpg"
              alt="Noche de Jazz"
              class="h-full w-full object-cover"
            />
        ...
        >
          ...
          <figure class="relative h-64 overflow-hidden">
            <img
              src="/src/assets/img/sabores-caribe.jpg"
      ...
      <article class="rounded-[28px] border border-slate-200 bg-white px-7 shadow-sm">
        ...
        <article class="flex gap-5 border-b border-slate-200 py-7">
          ...
          <figure class="shrink-0">
            <img
              src="/src/assets/img/laura-gomez.jpg"
        ...
        <article class="flex gap-5 py-7">
          ...
          <figure class="shrink-0">
            <img
              src="/src/assets/img/andres-silva.jpg"
...
export function perfilOrganizadorEvents() {
